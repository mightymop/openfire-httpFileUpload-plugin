...
public interface Repository
{
    ...
    String getFilename(SecureUniqueId paramUUID) throws IOException;
    
    boolean isDataBaseRepo();
    
    void purge(GregorianCalendar paramGregorianCalendar);
    
    long countRepoFiles();
    
    long getRepoSize();
    
    JSONArray getFiles(String paramString1, String paramString2, long paramLong1, long paramLong2, String paramString3) throws Exception;
}
